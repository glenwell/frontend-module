                    ...
                    <div class="row">
                        <div class="col-md-5 wrapthumbnail">
                            <a href="{{url($post->slug)}}">
                                ...
                                @endphp
                                <div class="thumbnail" style="background-image:url({{ filter_var($post->image, FILTER_VALIDATE_URL) ? $post->image : Voyager::image($post->image, "", $imageParams) }});">
                                </div>
                            </a>
                        </div>
                        <div class="col-md-7">
                            <div class="card-block">
                                ...
                                <h4 class="card-text">{{str_limit($post->excerpt, 200)}}</h4>
